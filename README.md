...
Для этого при помощи файла hack.c я создаю бинарный файл и заполняю его 20 "мусорными" символами и затем ещё 8 байтами адреса. И после этого получаю ошибку.. не понимаю в чем я ошибся


![image](https://github.com/RusakovD3/hw5_el/assets/103295869/98aa0979-bf72-4364-ba96-58b8ab30cefd)
